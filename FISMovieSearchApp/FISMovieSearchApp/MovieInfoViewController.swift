...
class MovieInfoViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        print("nav bar title is set to \(self.detailTitle)")
...
//      releasedLabel.backgroundColor = UIColor.blueColor()
...
//        directorLabel.backgroundColor = UIColor.redColor()
...
//        writerLabel.backgroundColor = UIColor.yellowColor()
...
//        starsLabel.backgroundColor = UIColor.purpleColor()
...
//        imdbScoreLabel.backgroundColor = UIColor.cyanColor()
...
//        metascoreLabel.backgroundColor = UIColor.greenColor()
    ...
    func allConstraints(){
        ...
        backviewForStack.centerYAnchor.constraintEqualToAnchor(self.view.centerYAnchor).active = true
        ...
        backviewForStack.topAnchor.constraintEqualToAnchor(self.shortPlotTextView.bottomAnchor, constant: view.frame.height * 0.02).active = true
        ...
        //        detailPosterView.topAnchor.constraintEqualToAnchor(self.view.topAnchor).active = true
        ...
        shortPlotTextView.topAnchor.constraintEqualToAnchor(self.detailPosterView.bottomAnchor, constant: view.frame.height * 0.02).active = true
        ...
        releasedLabel.leadingAnchor.constraintEqualToAnchor(self.view.leadingAnchor).active = true
        ...
        directorLabel.leadingAnchor.constraintEqualToAnchor(self.view.leadingAnchor).active = true
        ...
        writerLabel.leadingAnchor.constraintEqualToAnchor(self.view.leadingAnchor).active = true
        ...
        starsLabel.leadingAnchor.constraintEqualToAnchor(self.view.leadingAnchor).active = true
        ...
        imdbScoreLabel.leadingAnchor.constraintEqualToAnchor(self.view.leadingAnchor).active = true
        ...
        metascoreLabel.leadingAnchor.constraintEqualToAnchor(self.view.leadingAnchor).active = true
    ...
    func configureView(movieSelected: Movie){
        ...
        detailTitle = movieSelected.title
